...
contract ERC1155_YUITest is DSTestPlus {
    ...
    // function testSafeTransferFromToEOA( // fuzzing issues
    //     uint256 id,
    //     uint256 mintAmount,
    //     bytes memory mintData,
    ...
    // function testSafeTransferFromToERC1155Recipient( // same quesiton as  testMintToERC1155Recipient(  fuzzing,  id/amount/mintData all equal 0 doesn't test
    //     uint256 id,
    //     uint256 mintAmount,
    //     bytes memory mintData,
    //     uint256 transferAmount,
    ...
    // function testBatchMintToERC1155Recipient(  /fuzzig empty case
    //     uint256[] memory ids,
    //     uint256[] memory amounts,
    //     bytes memory mintData
    // ) public {
    ...
    // function testSafeBatchTransferFromToEOA( issues
    //     address to,
    //     uint256[] memory ids,
    ...
    // function testSafeBatchTransferFromToERC1155Recipient( fuzzing test case
    //     uint256[] memory ids,
    //     uint256[] memory mintAmounts,
    //     uint256[] memory transferAmounts,
    //     bytes memory mintData,
    ...
    // function testSafeTransferFromSelf( // fuzz issues
    //     uint256 id,
    //     uint256 mintAmount,
    //     bytes memory mintData,
    //     uint256 transferAmount,
